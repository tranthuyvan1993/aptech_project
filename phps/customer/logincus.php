	...
	<div class="container" style="width: 500px; height: auto; background-color: #B07F32;">
		<div>
			<ul class="nav nav-pills">
				...
				<li class="nav-item">
					<a href="registercus.php" title="" title="" class="nav-link">Register Form</a>
				</li>
			</ul>
		</div>
		<div>
		...
		<form action="" method="POST">
			...
			<div>
				<label>If you forgot the password. Reset here</label>
				<a href="reset.php" title=""><button class="btn btn-danger" type="button" style="margin-bottom: 10px">Reset</button></a>
			</div>
			<div>
				<label>If you want to change password. Click here</label>
				<a href="changepass.php" title=""><button class="btn btn-warning" type="button" style="margin-bottom: 10px">Change Pass</button></a>
			</div>
		</form>
	</div>
</body>
